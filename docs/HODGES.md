...
**References**: *Hodges 1994*, Section 2a; `threshold.c` and `object_local_maxs.c`.
...
**References**: *Hodges 1995*, Eq. 1; `geod_dev.c`.
...
**References**: *Hodges 1999*, Section 2; `fel_mge.c`.
...
**Reasoning**: As displacement (speed) increases, the directional constraint must become stricter. This is implemented as a piecewise linear function of mean displacement.
