...
This page provides an interactive visualization of storm tracks generated by PyStormTracker. It supports filtering by time, intensity, duration, and displacement, and includes both globe and latitude–longitude map projections.

<a href="_static/explorer.html" target="_blank" style="display: block; margin-bottom: 20px; font-weight: bold;">Open in New Tab</a>

<iframe src="_static/explorer.html" width="100%" height="1200px" frameborder="0" style="border: 1px solid #ddd; border-radius: 8px;"></iframe>
