...
*   A standalone benchmark script will install or locate SHTns separately and run the SHTns and ducc0 engines on identical fields.
...
## SHTns Polar-Optimization Result
