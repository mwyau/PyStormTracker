...
This document records Simple tracker execution times, in seconds, for the nested-object implementation in `v0.3.3` and the array-backed implementation in `v0.4.0`.
...
![0.25x0.25 Breakdown](_static/benchmark_0_25x0_25_breakdown.png)
