...
def test_hodges_tracker_track_single_chunk(mock_detect: MagicMock):
    ...
    with patch("pystormtracker.hodges.detector.HodgesDetector.get_time", return_value=[t0, t1]):
