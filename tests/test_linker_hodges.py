...
def test_hodges_linker_link_straight():
    linker = HodgesLinker()
    ...
    detections = [
        (t0, np.array([0.0, 10.0]), np.array([0.0, 10.0]), {"msl": np.array([1000.0, 1000.0])}),
        (t1, np.array([0.0, 10.0]), np.array([1.0, 11.0]), {"msl": np.array([990.0, 990.0])}),
        (t2, np.array([0.0, 10.0]), np.array([2.0, 12.0]), {"msl": np.array([980.0, 980.0])}),
    ]
...
def test_hodges_linker_link_crossing():
    """
    ...
    detections = [
        (t0, np.array([0.0, 0.0]), np.array([0.0, 10.0]), {"msl": np.array([1000.0, 1000.0])}),
        (t1, np.array([5.0, 5.0001]), np.array([5.0, 5.0001]), {"msl": np.array([990.0, 990.0])}),
        (t2, np.array([10.0, 10.0]), np.array([10.0, 0.0]), {"msl": np.array([980.0, 980.0])}),
    ]
