...
def test_spectral_filter_serial() -> None:
...
def test_spectral_filter_lat_reverse() -> None:
...
def test_spectral_filter_numpy_ndarray() -> None:
...
def test_spectral_filter_numpy_ndarray_3d() -> None:
