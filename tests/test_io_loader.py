...
@patch("xarray.open_dataset")
def test_ensure_open_grib(mock_open):
    mock_ds = MagicMock(spec=xr.Dataset)
    mock_open.return_value = mock_ds
...
@patch("xarray.open_dataset")
def test_ensure_open_caching(mock_open):
    mock_ds = MagicMock(spec=xr.Dataset)
    mock_open.return_value = mock_ds
...
@patch("xarray.open_dataset")
def test_get_coords_mapping(mock_open):
...
@patch("xarray.open_dataset")
def test_get_coords_mapping_aliases(mock_open):
...
@patch("xarray.open_dataset")
def test_get_coords_mapping_defaults(mock_open):
